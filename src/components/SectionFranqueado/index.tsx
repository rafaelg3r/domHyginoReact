          ...
          <section className={styles.franqueados}>
            <div className={styles.franqueadosContainer}>
              ...
              <p className={styles.text}>
                ...
                excelência no mercado de carnes. Construímos uma marca forte,
                com identidade própria, atendimento diferenciado e um
                compromisso inabalável com o sabor e a experiência do cliente. E
                agora, você pode fazer parte dessa história de sucesso!
              </p>
